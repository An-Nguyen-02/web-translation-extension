...
A web extension to add audio transcribe for English audio and translate to Vietnamese, show both text on screen.
...
2. An AI model that take the capture audio and output text (Khang)
3. An AI translation model to translate the output text of the Audio (Khang)
4. Show the appear text, control the text show on screen (An)
5. Extension to other languages (Khang)
6. Possible implementation with other existing cloud services and hosting of project (An)
